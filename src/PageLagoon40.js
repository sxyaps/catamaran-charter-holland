...
// Premium SVG Icons - consistent with PageCatamaran
const AnchorIcon = () => (
...
export default function PageLagoon40() {
  const { t } = useTranslation();
  const [modalOpen, setModalOpen] = useState(false);
  const [currentImageIndex, setCurrentImageIndex] = useState(0);

  // Optimized image loading - from public folder
  const heroImage = '/lagoon-photos/Catamaran-40-Avesenza-1.webp';
  
  const galleryImages = [
    { src: '/lagoon-photos/Catamaran-40-Avesenza-1.webp', alt: 'Lagoon 40 catamaran luxe huren Lelystad', title: 'Exterior View', subtitle: 'Beautiful Lagoon 40 catamaran on the water' },
    { src: '/lagoon-photos/Catamaran-40-Avesenza-2.webp', alt: 'Lagoon 40 salon', title: 'Main Salon', subtitle: 'Spacious and elegant living area' },
    { src: '/lagoon-photos/Catamaran-40-Avesenza-3.webp', alt: 'Lagoon 40 keuken', title: 'Galley', subtitle: 'Professional kitchen facilities' },
    { src: '/lagoon-photos/Catamaran-40-Avesenza-4.webp', alt: 'Lagoon 40 hut', title: 'Master Cabin', subtitle: 'Luxury sleeping quarters' },
    { src: '/lagoon-photos/Catamaran-40-Avesenza-5.webp', alt: 'Lagoon 40 badkamer', title: 'Bathroom', subtitle: 'Modern bathroom facilities' },
    { src: '/lagoon-photos/Catamaran-40-Avesenza-6.webp', alt: 'Lagoon 40 dek', title: 'Deck Area', subtitle: 'Spacious outdoor deck space' },
    { src: '/lagoon-photos/Catamaran-40-Avesenza-7.webp', alt: 'Lagoon 40 lounge', title: 'Lounge Area', subtitle: 'Perfect for relaxation' },
    { src: '/lagoon-photos/Catamaran-40-Avesenza-8.webp', alt: 'Lagoon 40 zeilen', title: 'Under Sail', subtitle: 'Experience perfect sailing conditions' },
  ];
  ...
  // Translation data
  const specs = t('lagoon40.specs', { returnObjects: true });
  const onBoard = t('lagoon40.onBoard', { returnObjects: true });
  const features = t('lagoon40.features', { returnObjects: true });
  const destinations = t('lagoon40.destinations', { returnObjects: true });
    ...
    <main className="main-content">
      ...
      >
        <div className="catamaran-hero-content">
          <div className="catamaran-hero-text">
            <h1 className="catamaran-hero-title">{t('lagoon40.heroTitle')}</h1>
            <p className="catamaran-hero-subtitle">{t('lagoon40.heroSubtitle')}</p>
          ...
          <div className="catamaran-hero-visual">
            <img 
              src={heroImage} 
              alt="Lagoon 40 catamaran luxe huren" 
      ...
      <section className="section catamaran-section-block">
        <div style={{textAlign: 'center', maxWidth: '800px', margin: '0 auto'}}>
          <p style={{fontSize: '1.2rem', lineHeight: 1.7}}>{t('lagoon40.intro1')}</p>
          <blockquote className="catamaran-highlight">
            "{t('lagoon40.highlights')}"
          </blockquote>
          <p style={{fontSize: '1.1rem'}}>{t('lagoon40.intro2')}</p>
        </div>
      </section>
      ...
      <section id="gallery" className="catamaran-gallery-premium">
        <div className="container">
          <div className="catamaran-gallery-header">
            <h2 className="catamaran-gallery-title">{t('lagoon40.galleryTitle')}</h2>
            <p className="catamaran-gallery-subtitle">Ontdek elke hoek van deze luxueuze Lagoon 40</p>
          </div>
      ...
      <section id="booking" className="catamaran-booking-section">
        <div className="container">
          <div className="catamaran-booking-header">
            <h2 className="catamaran-booking-title">Boek nu je luxe zeilervaring</h2>
      ...
      <section className="section">
        <div className="container">
          <h2 className="catamaran-gallery-title" style={{textAlign: 'center', marginBottom: '3rem'}}>{t('lagoon40.specsTitle')}</h2>
      ...
      {/* FEATURES */}
      <section className="section catamaran-section-block">
        <h2 className="catamaran-title" style={{fontSize: '2rem', textAlign: 'center'}}>{t('lagoon40.featuresTitle')}</h2>
        <div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '3rem', marginTop: '2rem'}}>
          <div>
            <h3 style={{color: 'var(--gold)', fontSize: '1.5rem', marginBottom: '1rem'}}>{t('lagoon40.onBoardTitle')}</h3>
      ...
      {/* DESTINATIONS */}
      <section className="section catamaran-section-block">
        <h2 className="catamaran-title" style={{fontSize: '2rem', textAlign: 'center'}}>{t('lagoon40.destinationsTitle')}</h2>
        <p style={{textAlign: 'center', maxWidth: '700px', margin: '0 auto 2rem auto', fontSize: '1.1rem'}}>{t('lagoon40.destinationsText')}</p>
      ...
      <section className="section catamaran-section-block" style={{textAlign: 'center'}}>
        <h2 className="catamaran-title" style={{fontSize: '2rem'}}>{t('lagoon40.serviceTitle')}</h2>
        <div style={{maxWidth: '800px', margin: '0 auto'}}>
          <p style={{fontSize: '1.1rem', lineHeight: 1.7}}>{t('lagoon40.serviceText1')}</p>
          <p style={{fontSize: '1.1rem', lineHeight: 1.7}}>{t('lagoon40.serviceText2')}</p>
        </div>
      </section>
      ...
      <section className="catamaran-booking-section" style={{marginTop: '4rem'}}>
        <div className="container" style={{textAlign: 'center'}}>
          <h2 className="catamaran-booking-title" style={{fontSize: '2.5rem', marginBottom: '1rem'}}>{t('lagoon40.ctaTitle')}</h2>
          <p style={{fontSize: '1.2rem', maxWidth: '700px', margin: '0 auto 2rem auto', color: 'var(--off-white)'}}>{t('lagoon40.ctaText')}</p>
          <div style={{display: 'flex', gap: '1.5rem', justifyContent: 'center', flexWrap: 'wrap'}}>
            <a href="#booking" className="catamaran-btn-primary" style={{fontSize: '1.2rem', padding: '1.2rem 3rem'}}>
              <span>{t('lagoon40.bookNow')}</span>
              <ShipIcon />
            </a>
